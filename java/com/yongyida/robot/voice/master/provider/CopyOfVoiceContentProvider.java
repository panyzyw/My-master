 ...
 */  
public class CopyOfVoiceContentProvider extends ContentProvider {  
    // 自己实现的数据库操作帮助类  
...
//        }  
    ...
    public Uri insert(Uri uri, ContentValues values) { 
    	try {
            ...
            switch (code) {  
            case 1:            	
                sqLiteDatabase.insert(Table_Name, "datetime", values);  
                break;  
            case 2:             	
                long id = sqLiteDatabase.insert(Table_Name, "datetime", values);  
